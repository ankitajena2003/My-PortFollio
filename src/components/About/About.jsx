      ...
      <div className="flex flex-col-reverse md:flex-row justify-between items-center">
        ...
        <div className="md:w-1/2 text-center md:text-left mt-8 md:mt-0">
          ...
          <p className="text-base sm:text-lg md:text-lg text-gray-400 mb-10 mt-8 leading-relaxed">
            I am a passionate full-stack web developer currently working
             as an intern at Qlith Pvt. Ltd. I have hands-on experience in
              building responsive and user-friendly web applications using
               the MERN stack and other modern technologies. Eager to learn
                and grow, I focus on writing clean, maintainable code and
                 developing seamless user experiences while continuously 
        ...
        <div className="md:w-1/2 flex justify-center md:justify-end">
          ...
          >
            <img
              src="https://avatars.githubusercontent.com/u/214230665?v=4"
              alt="Ankita Jena"
